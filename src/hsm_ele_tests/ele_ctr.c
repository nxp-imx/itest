...
int ele_ctr(void)
{
	...
	for (i = 0; i < NUM_MSG_SIZE; i++) {
		ITEST_LOG("AES-128-CTR encryption for 1s on %d byte blocks: ",
			  block_size[i]);
		...
		ITEST_LOG("AES-128-CTR decryption for 1s on %d byte blocks: ",
			  block_size[i]);
	...
	for (i = 0; i < NUM_MSG_SIZE; i++) {
		ITEST_LOG("AES-192-CTR encryption for 1s on %d byte blocks: ",
			  block_size[i]);
		...
		ITEST_LOG("AES-192-CTR decryption for 1s on %d byte blocks: ",
			  block_size[i]);
	...
	for (i = 0; i < NUM_MSG_SIZE; i++) {
		ITEST_LOG("AES-256-CTR encryption for 1s on %d byte blocks: ",
			  block_size[i]);
		...
		ITEST_LOG("AES-256-CTR decryption for 1s on %d byte blocks: ",
			  block_size[i]);

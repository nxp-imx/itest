...
int ele_ecb(void)
{
	...
	for (i = 0; i < NUM_MSG_SIZE; i++) {
		ITEST_LOG("AES-128-ECB encryption for 1s on  %d byte blocks: ",
			  block_size[i]);
		...
		ITEST_LOG("AES-128-ECB decryption for 1s on  %d byte blocks: ",
			  block_size[i]);
	...
	for (i = 0; i < NUM_MSG_SIZE; i++) {
		ITEST_LOG("AES-192-ECB encryption for 1s on  %d byte blocks: ",
			  block_size[i]);
		...
		ITEST_LOG("AES-192-ECB decryption for 1s on  %d byte blocks: ",
			  block_size[i]);
	...
	for (i = 0; i < NUM_MSG_SIZE; i++) {
		ITEST_LOG("AES-256-ECB encryption for 1s on  %d byte blocks: ",
			  block_size[i]);
		...
		ITEST_LOG("AES-256-ECB decryption for 1s on  %d byte blocks: ",
			  block_size[i]);

...
int seco_ks_import_export_001(void){
    ...
    ASSERT_NOT_EQUAL(save_test_ctx(&ctx, sizeof(test_ctx_t), "seco_ks_imp_exp_test_ctx.bin"), 0);
...
int seco_ks_import_export_001_part2(void){
    ...
    ASSERT_NOT_EQUAL(load_test_ctx(&ctx, sizeof(test_ctx_t), "seco_ks_imp_exp_test_ctx.bin"), 0);

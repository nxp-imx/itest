...
int seco_otp_kek_001_test(void){
    ...
    ASSERT_EQUAL(isen_hsm_key_injection_otp_kek(sg0_key_mgmt_srv, &key_id_aes_128, HSM_KEY_TYPE_AES_128, aes_128_key_data, 16), TRUE_TEST);

    // =========== INJECT KEYS FOR AES GCM TEST ================= //
    ASSERT_EQUAL(isen_hsm_key_injection_otp_kek(sg0_key_mgmt_srv, &key_id_aes_192, HSM_KEY_TYPE_AES_192, aes_192_key_data, 24), TRUE_TEST);

    // =========== INJECT KEYS FOR AES GCM TEST ================= //
    ASSERT_EQUAL(isen_hsm_key_injection_otp_kek(sg0_key_mgmt_srv, &key_id_aes_256, HSM_KEY_TYPE_AES_256, aes_256_key_data, 32), TRUE_TEST);

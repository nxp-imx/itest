...
int verify_signature(int curve, unsigned char *pubk, int size_pubk, unsigned char *privk, int size_privk, unsigned char *in, int size, char *dgst, unsigned char *out_sign, int sign_size);
